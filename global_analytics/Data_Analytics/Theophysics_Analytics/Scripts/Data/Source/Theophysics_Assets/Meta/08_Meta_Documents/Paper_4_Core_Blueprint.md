---
uuid: 22e04382-6210-55ec-91ad-ced43cde685b
title: Paper 4 Core Blueprint
author: David Lowe
type: paper
created: '2025-11-22'
updated: '2025-11-22'
status: draft
file_path: Logos zright\Papers\08_Meta_Documents\Paper_4_Core_Blueprint.md
uuid_generated_at: '2025-11-22T01:23:51.614314'
uuid_version: '1.0'
tags: []
pillars: []
...
- **Integrated Information Theory (IIT):** Asserts an identity between information and experience, but doesn't explain _why_ that property should be experiential.
...
_The following is a new, alternative framework for Paper #4, which reframes the problem of consciousness by wedding it to the problem of time. It is presented here as a candidate for replacing the above, pending final review._
...
Why does time flow forward? The fundamental equations of physics are time-symmetric. The standard explanation relies on the Second Law of Thermodynamics, but this only explains the _direction_ of the arrow, not the arrow's existence. It doesn't explain why time _flows_ at all.
...
[Previous: Paper 3](./Paper%203%20The%20Algorithm%20of%20Reality.md) | [Home](./00-Series-Index.md) | [Next: Paper 5](./Paper%205%20The%20Soul%20as%20Quantum%20Observer.md)